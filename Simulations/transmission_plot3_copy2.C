...
//	h34->Draw("e same");
	...
	double MC_carbon_T[6] = {0.68212896,0.695419022,0.728697956,0.640915467,0.629852109,0.606475282};
        double Data_carbon_T_corrected2[4] = {0.542681,0.623761,0.629435,0.427182};
        ...
        double Data_corr2_carbon_T_err[4] = {0.0169434,0.030841,0.0749084,0.0448565};
        ...
        g_MC2_Carbon->SetLineColor(kOrange+1);
 ...
 //       legend->AddEntry( g_Data_Carbon_corrected2, "C12 - CLAS (neutron + mec corrections)","p");
        ...
        legend->AddEntry( g_MC_Carbon, "C12 - SuSav2 (e, p) / (e)","l");
        legend->AddEntry( g_MC2_Carbon, "C12 - GENIE [(e, p) with FSI] / [(e, p) without FSI]","l");
...
//        g_Data_Carbon_corrected2->Draw("p same");
	...
	c->SaveAs(TString::Format("transparency_C12_2261_G18_02a_00_000_everything2_no1161.pdf"));
