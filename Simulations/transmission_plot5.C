...
TFile *input5 = TFile::Open("transmission_C12_2261_EMQE_G18_02a_00_000_redo_el_mom_1.9_el_theta_20_25.root");
TFile *input6 = TFile::Open("transmission_C12_2261_EMQE_G18_02a_00_000_noFSI_redo_el_mom_1.9_el_theta_20_25.root");

TFile *input7 = TFile::Open("test_transmission_C12_2261_EMQE_G18_02a_00_000_redo_el_mom_1.9_el_theta_20_25_elsector_elphi.root");
TFile *input8 = TFile::Open("transmission_C12_2261_EMQE_G18_02a_00_000_noFSI_redo_el_mom_1.9_el_theta_20_25_elsector_elphi.root");
...
TH1D* h7 = (TH1D*)input7->Get(TString::Format("Tp_SuSav2"));
TH1D* h8 = (TH1D*)input8->Get(TString::Format("Tp_SuSav2"));
TH1D* h78 = (TH1D*)h7->Clone("h78");
...
h12->SetTitle("2.261 GeV e^{-} Beam C-12, Range 1");
h12->SetStats(0);
...
h34->SetTitle("2.261 GeV e^{-} Beam C-12, Range 1");
h34->SetStats(0);
...
h78->Sumw2();
h78->Divide(h8);
h78->GetXaxis()->SetTitle("Proton Kinetic Energy [GeV]");
h78->GetXaxis()->CenterTitle(true);
h78->GetYaxis()->SetTitle("Transparency");
...
const double leg_x1 = 0.4; // x-axis lower bound for the legend
const double leg_x2 = 0.8; // x-axis upper bound for the legend
const double leg_y1 = 0.7; // y-axis lower bound for the legend
const double leg_y2 = 0.88; // y-axis upper bound for the legend

TLegend *legend = new TLegend( leg_x1, leg_y1, leg_x2, leg_y2) ;
//TLegend *legend = new TLegend(0.65, 0.775, 0.9, 0.88);
legend->AddEntry(h12,"C-12 with no cut","l");
legend->AddEntry(h34,"C-12 with p_{e} cut","l");
legend->AddEntry(h56,"C-12 with p_{e}, #theta_{e} cuts","l");
legend->AddEntry(h78,"C-12 with p_{e}, #theta_{e}, #phi_{e}, sector cuts","l");
legend->SetBorderSize(0);
legend->SetFillStyle(0);
legend->Draw();

//c->SaveAs(TString::Format("el_mom_1.9_el_theta_20_25_elsector_elphi_transparency_prot_KE_2261_G18_02a_00_000.pdf"));
