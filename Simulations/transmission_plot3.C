...
//      double Data_carbon_T[3] = {.376828,.41648,.349001};
        ...
        */
        ...
        g_Data_Carbon->GetXaxis()->SetTitle("Proton Momentum [GeV/c]");
...
legend->AddEntry(h12,"C-12 - True GENIE @ 2.261 GeV","l");
legend->SetFillStyle(0);
legend->Draw();

c->SaveAs(TString::Format("transparency_C12_2261_G18_02a_00_000_everything.pdf"));
