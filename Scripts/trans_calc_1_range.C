...
//	double corrRange[3] = {0.73469447,0.67918725,0.66175208};
	...
	//double corrRange[3] = {0.69712351,0.,0.};
...
// Users don't have to read all the code below this dashed line unless they want to do a deep dive into the code, or if they want to debug, etc.
	...
	std::string data_file_path ("/genie/app/users/nsteinbe/e4nu/CLAS/DATA/Full_Data_Sample/Fe56/");
	...
	std::string mc_incl[N_RANGES];
        ...
        mc_incl[0] = mc_file_path + "Inclusive/Inclusive_Range1_Genie_1_56Fe_4.461000.root";
        mc_excl[0] = mc_file_path + "Exclusive/Exclusive_Range1_Genie_1_56Fe_4.461000.root";

        data_incl[0] = data_file_path + "Inclusive_Range1_Data__56Fe_4.461000.root";
        data_excl[0] = data_file_path + "Exclusive_Range1_Data__56Fe_4.461000.root";
