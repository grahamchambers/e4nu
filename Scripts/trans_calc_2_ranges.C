...
//	double corrRange[3] = {0.75832654,0.72603164,0.66924105};
	...
	std::string data_file_path ("/genie/app/users/nsteinbe/e4nu/CLAS/DATA/Full_Data_Sample/C12/");
	//std::string data_file_path ("/genie/app/users/gchamber/e4nu_2022/e4nu/output/output2022/Analysis29/");
	...
	std::string mc_incl[N_RANGES];
        ...
        data_incl[1] = data_file_path + "Inclusive_Range2_Data__C12_1.161000.root";
        data_incl[2] = data_file_path + "Inclusive_Range3_Data__C12_1.161000.root";
        data_excl[1] = data_file_path + "Exclusive_Range2_Data__C12_1.161000.root";
        data_excl[2] = data_file_path + "Exclusive_Range3_Data__C12_1.161000.root";
	...
	for (int idx = 1; idx < N_RANGES; idx++) { 
