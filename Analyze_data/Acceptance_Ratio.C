...
//	for (int i=0;i<1;i++){
	...
	legend->AddEntry(h1_prot_mom_sectors_interactions_mc2[0][0][0],"Genie Range 1","l");
	...
	legend->AddEntry(h1_prot_mom_sectors_interactions_mc2_susa[0][0][0],"SuSav2 Range 1","l");
	...
	legend->AddEntry(h1_prot_mom_sectors_interactions_mc3[0][0][0],"Average Range 1","l");
	...
	c->SaveAs(TString::Format("Acceptance_xsec_ratios_combined_avg.pdf"));
