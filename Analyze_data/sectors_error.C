//This script calculates is sqrt(Sum_i (T_i - T_1)^2)/sqrt(3) where T_i is transparency in sector i and T_1 is transparency in sector 1
...
void sectors_error() {
	...
	TFile *input_data_sector1_incl;
	TFile *input_data_sector2_incl;
	TFile *input_data_sector6_incl;
	...
	TFile *input_mc_sector6;
        ...
        std::string data_sector1_incl[N_RANGES];
        std::string data_sector2_incl[N_RANGES];
        std::string data_sector6_incl[N_RANGES];
	...
	*/
	...
	data_sector1_incl[0] = "/pnfs/genie/persistent/users/gchamber/output2022/Analysis21/Inclusive/Inclusive_Range1_Data__C12_2.261000.root";
	data_sector1_incl[1] = "/pnfs/genie/persistent/users/gchamber/output2022/Analysis21/Inclusive/Inclusive_Range2_Data__C12_2.261000.root";
	data_sector1_incl[2] = "/pnfs/genie/persistent/users/gchamber/output2022/Analysis21/Inclusive/Inclusive_Range3_Data__C12_2.261000.root";
	data_sector2_incl[0] = "/pnfs/genie/persistent/users/gchamber/output2022/Analysis20/Inclusive/Inclusive_Range1_Data__C12_2.261000.root";
	data_sector2_incl[1] = "/pnfs/genie/persistent/users/gchamber/output2022/Analysis20/Inclusive/Inclusive_Range2_Data__C12_2.261000.root";
	data_sector2_incl[2] = "/pnfs/genie/persistent/users/gchamber/output2022/Analysis20/Inclusive/Inclusive_Range3_Data__C12_2.261000.root";
	data_sector6_incl[0] = "/pnfs/genie/persistent/users/gchamber/output2022/Analysis19/Inclusive/Inclusive_Range1_Data__C12_2.261000.root";
	data_sector6_incl[1] = "/pnfs/genie/persistent/users/gchamber/output2022/Analysis19/Inclusive/Inclusive_Range2_Data__C12_2.261000.root";
	data_sector6_incl[2] = "/pnfs/genie/persistent/users/gchamber/output2022/Analysis19/Inclusive/Inclusive_Range3_Data__C12_2.261000.root";
	...
	TH1D* h1_prot_mom_sector1_data_incl[N_RANGES][N_SECTORS];
	TH1D* h1_prot_mom_sector2_data_incl[N_RANGES][N_SECTORS];
	TH1D* h1_prot_mom_sector6_data_incl[N_RANGES][N_SECTORS];
	...
	//TH1D* h1_prot_mom_sector6_interactions_mc[N_RANGES][N_SECTORS][N_INT];
	 ...
	 for (int file_i = 0; file_i < N_RANGES; file_i++){
		...
		input_data_sector1_incl = TFile::Open( TString::Format("%s", data_sector1_incl[file_i].c_str()));	
		input_data_sector2_incl = TFile::Open( TString::Format("%s", data_sector2_incl[file_i].c_str()));	
		input_data_sector6_incl = TFile::Open( TString::Format("%s", data_sector6_incl[file_i].c_str()));	
		...
		// loop over sectors
			 ...
			 h1_prot_mom_sector1_data_incl[file_i][sector] = (TH1D*)input_data_sector1_incl->Get( TString::Format("h1_0_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__%i", sector));
			 h1_prot_mom_sector2_data_incl[file_i][sector] = (TH1D*)input_data_sector2_incl->Get( TString::Format("h1_0_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__%i", sector));
			 h1_prot_mom_sector6_data_incl[file_i][sector] = (TH1D*)input_data_sector6_incl->Get( TString::Format("h1_0_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_prot_mom_QE__%i", sector));
			...
			if(sector == 0) continue;
                                ...
                                h1_prot_mom_sector1_data_incl[file_i][0]->Add(h1_prot_mom_sector1_data_incl[file_i][sector]);
                                h1_prot_mom_sector2_data_incl[file_i][0]->Add(h1_prot_mom_sector2_data_incl[file_i][sector]);
                                h1_prot_mom_sector6_data_incl[file_i][0]->Add(h1_prot_mom_sector6_data_incl[file_i][sector]);
                        }
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	for (int i=0;i<3;i++){
		...
		h1_prot_mom_sector1_data_incl[i][0]->Rebin(40);	
		h1_prot_mom_sector2_data_incl[i][0]->Rebin(40);	
		h1_prot_mom_sector6_data_incl[i][0]->Rebin(40);	
		...
		*/
		...
		seci_sec1_difference_squared_sum[i] += pow((h1_prot_mom_sector1_data[i][0]->Integral()/h1_prot_mom_sector1_data_incl[i][0]->Integral()) - (h1_prot_mom_sector1_data[i][0]->Integral()/h1_prot_mom_sector1_data_incl[i][0]->Integral()),2);
		//std::cout << h1_prot_mom_sector2_data[i][0]->Integral() - h1_prot_mom_sector1_data[i][0]->Integral() << std::endl;
		seci_sec1_difference_squared_sum[i] += pow((h1_prot_mom_sector2_data[i][0]->Integral()/h1_prot_mom_sector2_data_incl[i][0]->Integral()) -( h1_prot_mom_sector1_data[i][0]->Integral()/h1_prot_mom_sector1_data_incl[i][0]->Integral()),2);
		seci_sec1_difference_squared_sum[i] += pow((h1_prot_mom_sector6_data[i][0]->Integral()/h1_prot_mom_sector6_data_incl[i][0]->Integral()) - (h1_prot_mom_sector1_data[i][0]->Integral()/h1_prot_mom_sector1_data_incl[i][0]->Integral()),2);
	}
