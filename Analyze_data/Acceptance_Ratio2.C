...
//	for (int i=0;i<1;i++){
	for (int i=0;i<3;i++){
		...
		h1_prot_mom_sectors_interactions_mc1_susa[i][0][0]->Rebin(40);
		
		h1_prot_mom_sectors_interactions_mc_susa[i][0][0]->SetStats(0);
		h1_prot_mom_sectors_interactions_mc_susa[i][0][0]->SetLineColor(color_options[i]);
		h1_prot_mom_sectors_interactions_mc1_susa[i][0][0]->SetLineColor(color_options[i]);
		h1_prot_mom_sectors_interactions_mc_susa[i][0][0]->SetLineStyle(kDashed);
		//h1_prot_mom_sectors_interactions_mc1_susa[i][0][0]->SetLineStyle(kDotted);
		h1_prot_mom_sectors_interactions_mc_susa[i][0][0]->GetXaxis()->SetTitle("Proton Momentum [GeV/c]");
		//h1_prot_mom_sectors_interactions_mc2[i][0][0]->Rebin(10);	
		//h1_prot_momentum[i]->GetYaxis()->SetTitle("d^{2}#sigma/dEd#Omega");
		h1_prot_mom_sectors_interactions_mc_susa[i][0][0]->GetYaxis()->SetTitle("Events");
		h1_prot_mom_sectors_interactions_mc_susa[i][0][0]->GetXaxis()->SetRangeUser(0,2);
		h1_prot_mom_sectors_interactions_mc_susa[i][0][0]->GetYaxis()->SetRangeUser(0,300);
	//	h1_prot_momentum[i]->SetMaximum(.1);
		...
		h1_prot_mom_sectors_interactions_mc_susa[i][0][0]->Draw(draw_options[i]);
		h1_prot_mom_sectors_interactions_mc1_susa[i][0][0]->Draw(draw_options[i+1]);
	...
	TLegend *legend = new TLegend(0.6, 0.6, 0.875, 0.88);
	...
	legend->AddEntry(h1_prot_mom_sectors_interactions_mc_susa[0][0][0],"SuSav2 (w/ Rad) Range 1","l");
	legend->AddEntry(h1_prot_mom_sectors_interactions_mc_susa[1][0][0],"SuSav2 (w/ Rad) Rad Range 2","l");
	legend->AddEntry(h1_prot_mom_sectors_interactions_mc_susa[2][0][0],"SuSav2 (w/ Rad) Rad Range 3","l");
	legend->AddEntry(h1_prot_mom_sectors_interactions_mc1_susa[0][0][0],"SuSav2 (w/o Rad) Range 1","l");
	legend->AddEntry(h1_prot_mom_sectors_interactions_mc1_susa[1][0][0],"SuSav2 (w/o Rad) Range 2","l");
	legend->AddEntry(h1_prot_mom_sectors_interactions_mc1_susa[2][0][0],"SuSav2 (w/o Rad) Range 3","l");
	legend->SetBorderSize(0);
	legend->SetFillStyle(0);
	legend->Draw();

	c->SaveAs(TString::Format("rad_xsec_ratios_combined_avg.pdf"));
