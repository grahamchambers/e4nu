...
void xsec_data_corr2_1161() {
	...
	TFile *input_data_incl;
        ...
        data_excl[1] = "/genie/app/users/nsteinbe/e4nu/CLAS/DATA/Full_Data_Sample/C12/Exclusive_Range2_Data__C12_1.161000.root";
        data_excl[2] = "/genie/app/users/nsteinbe/e4nu/CLAS/DATA/Full_Data_Sample/C12/Exclusive_Range3_Data__C12_1.161000.root";
      
        data_incl[1] = "/genie/app/users/nsteinbe/e4nu/CLAS/DATA/Full_Data_Sample/C12/Inclusive_Range2_Data__C12_1.161000.root";
        data_incl[2] = "/genie/app/users/nsteinbe/e4nu/CLAS/DATA/Full_Data_Sample/C12/Inclusive_Range3_Data__C12_1.161000.root";
	
	double neutron_corr[3] = {0.,0.82984332,0.79305131};
	double neutron_corr_err[3] = {0.,0.,0.};

	double mec_corr[3] = {0.,0.955227,0.940607};
	double mec_corr_err[3] = {0.,0.00125414,0.0035642};
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/*        mc_excl_susa[0] = "../output/output2022/Analysis26/Exclusive/Exclusive_reco_Range1_Genie_1_C12_1.161000.root";
        mc_excl_susa[1] = "../output/output2022/Analysis26/Exclusive/Exclusive_reco_Range2_Genie_1_C12_1.161000.root";
        mc_excl_susa[2] = "../output/output2022/Analysis26/Exclusive/Exclusive_reco_Range3_Genie_1_C12_1.161000.root";

        mc_excl1_susa[0] = "../output/output2022/Analysis26/Exclusive/Exclusive_Range1_Genie_1_C12_1.161000.root";
        mc_excl1_susa[1] = "../output/output2022/Analysis26/Exclusive/Exclusive_Range2_Genie_1_C12_1.161000.root";
        mc_excl1_susa[2] = "../output/output2022/Analysis26/Exclusive/Exclusive_Range3_Genie_1_C12_1.161000.root";

        mc_excl[0] = "../output/output2022/Analysis26/Exclusive/Exclusive_reco_accept_Range1_Genie_2_C12_1.161000.root";
        mc_excl[1] = "../output/output2022/Analysis26/Exclusive/Exclusive_reco_accept_Range2_Genie_2_C12_1.161000.root";
        mc_excl[2] = "../output/output2022/Analysis26/Exclusive/Exclusive_reco_accept_Range3_Genie_2_C12_1.161000.root";

        mc_excl1[0] = "../output/output2022/Analysis26/Exclusive/Exclusive_Range1_Genie_2_C12_1.161000.root";
        mc_excl1[1] = "../output/output2022/Analysis26/Exclusive/Exclusive_Range2_Genie_2_C12_1.161000.root";
        mc_excl1[2] = "../output/output2022/Analysis26/Exclusive/Exclusive_Range3_Genie_2_C12_1.161000.root";
*/
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	const char * draw_options[3] = {"HIST","HIST","HIST SAME"};
//////////////////////////////////////////////////////////////////////////////////////
	...
	//SuSav2 Rad
        UniversalE4vFunction(h1_prot_mom_sectors_interactions_mc_susa_radcorr[1][0][0],"SuSav2 Rad Updated Schwinger","12C","1_161","h1_prot_mom14");
        UniversalE4vFunction(h1_prot_mom_sectors_interactions_mc_susa_radcorr[2][0][0],"SuSav2 Rad Updated Schwinger","12C","1_161","h1_prot_mom15"); 
        //SuSav2 No Rad 
	UniversalE4vFunction(h1_prot_mom_sectors_interactions_mc1_susa_radcorr[1][0][0],"SuSav2 NoRad","12C","1_161","h1_prot_mom16"); 
        UniversalE4vFunction(h1_prot_mom_sectors_interactions_mc1_susa_radcorr[2][0][0],"SuSav2 NoRad","12C","1_161","h1_prot_mom17");
	...
	//data scaling
	UniversalE4vFunction(h1_prot_mom_sectors_data[1][0],"Pinned Data","12C","1_161","h1_prot_mom20");
	UniversalE4vFunction(h1_prot_mom_sectors_data[2][0],"Pinned Data","12C","1_161","h1_prot_mom21");
	UniversalE4vFunction(h1_prot_mom_sectors_data_incl[1][0],"Pinned Data","12C","1_161","h1_prot_mom23");
	UniversalE4vFunction(h1_prot_mom_sectors_data_incl[2][0],"Pinned Data","12C","1_161","h1_prot_mom24");
	...
	for (int i=1;i<3;i++){
		...
		h1_prot_mom_sectors_data[i][0]->GetXaxis()->SetRangeUser(0,1);
	//	h1_prot_momentum[i]->SetMaximum(.1);
		...
		h1_prot_mom_sectors_data[i][0]->SetTitle("C-12 @ 1.161 GeV e^{-} Beam (CLAS with exclusive cuts)");
	...
	legend->AddEntry(h1_prot_mom_sectors_interactions_mc3[1][0][0],"Range 2","l");
	//legend->AddEntry(h1_prot_mom_sectors_data[1][0],"Range 2","l");
	legend->AddEntry(h1_prot_mom_sectors_interactions_mc3[2][0][0],"Range 3","l");
	//legend->AddEntry(h1_prot_mom_sectors_data[2][0],"Range 3","l");
	legend->SetBorderSize(0);
	legend->SetFillStyle(0);
	legend->Draw();

	c->SaveAs(TString::Format("acceptance_ratio_1161.pdf"));
